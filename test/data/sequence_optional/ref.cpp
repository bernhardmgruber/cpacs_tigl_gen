...
namespace generated
{
    ...
    public:
        ...
        TIGL_EXPORT virtual const boost::optional<int>& GetH() const;
        TIGL_EXPORT virtual void SetH(const boost::optional<int>& value);
...
namespace generated
{
    ...
    void CPACSRoot::WriteCPACS(const TixiDocumentHandle& tixiHandle, const std::string& xpath) const
    {
        ...
        if (m_h) {
            ...
            if (tixi::TixiCheckElement(tixiHandle, xpath + "/h")) {
                tixi::TixiRemoveElement(tixiHandle, xpath + "/h");
            }
        }
    ...
    const boost::optional<int>& CPACSRoot::GetH() const
    {
        return m_h;
    }

    void CPACSRoot::SetH(const boost::optional<int>& value)
    {
        m_h = value;
    }
